...
public class AsyncAcceptOrRejectRequestUser extends AsyncTask<RequestDTO, Void ,RequestDTO > {
    ...
    public AsyncAcceptOrRejectRequestUser(final Context context, FragmentManager fragmentManager , boolean newRequest) {
    ...
    protected RequestDTO doInBackground(RequestDTO... params) {
        ...
        try{
            ...
            httpURLConnection = (HttpURLConnection) new URL(WebService.USER_API_ACCEPT_OR_REJECT_REQUEST).openConnection();
